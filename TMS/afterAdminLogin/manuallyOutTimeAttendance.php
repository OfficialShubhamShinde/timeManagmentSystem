...
<head>
    ...
    <link rel="stylesheet" href="../afterAdminLogin/assets/css/stylesForClock.css">
</head>
...
<body>
    ...
    <div class="vertical-nav bg-white" id="sidebar">
        ...
        <ul class="nav flex-column bg-white mb-0">
            ...
            <li class="nav-item dropdown">
                <a href="attendanceAdmin.php" class="nav-link text-dark ropdown-toggle  bg-light"
    ...
    <div class="page-content p-5" id="content">
        ...
        <center>
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                $empIDForManuallyOut = $_POST['empIDForManuallyOut'];
                $empDateTimeForManuallyOut = $_POST['empDateTimeForManuallyOut'];
                include '../_dbconnect.php';

                $insertData = "INSERT INTO `empouttime` (`empid`, `manuallyout`) VALUES  ('$empIDForManuallyOut', '$empDateTimeForManuallyOut')";
                ...
                if ($result) {
                    ...
                    <strong>Success!</strong> Employee Out Time Added Successfully
            ...
            ?>
                ...
                <br>
                <form action="manuallyOutTimeAttendance.php" method="post">
                    <div class="row">
                        <center>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="empIDForManuallyOut" placeholder="Enter Employee ID"
                                    aria-label="First name" required>
                            </div>
                            <div class="col-md-4">
                                <input type="datetime-local" class="form-control mt-3" name="empDateTimeForManuallyOut" placeholder="Enter Out Time"
                                    aria-label="First name" required>
                            </div>
                    ...
                    <div class="buttonsInAttendance ms-9">
                        <button type="submit" class="btn btn-outline-dark mt-3">Add Manually Out Time</button>
                    </div>
                </form>
            </div>
        </center>
    ...
    <script src="../afterAdminLogin/assets/js/stylesForClock.js"></script>
</body>
