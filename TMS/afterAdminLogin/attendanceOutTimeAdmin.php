    ...
    <div class="page-content p-5" id="content">
        ...
        <center>
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                $EmpIDOut = $_POST['empIDOut'];
                include '../_dbconnect.php';

                $insertData = "INSERT INTO `empouttime` (`empid`) VALUES ('$EmpIDOut');";
                ...
                if ($result) {
                    ...
                    <strong>Success!</strong> Employee Out at <strong>'.date('m/d/Y h:i:s a', time()).'</strong>
            ...
            ?>
                ...
                <br>
                <form action="attendanceOutTimeAdmin.php" method="post">
                    <div class="row">
                        <center>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="empIDOut" placeholder="Enter Employee ID"
                    ...
                    <button type="submit" class="btn btn-outline-dark mt-3">Out Time</button>
                    <a class="btn btn-outline-dark mt-3" href="manuallyOutTimeAttendance.php" role="button">Add Manually</a>
                    </div>
                </form>
            </div>
        </center>
