    ...
    <div class="page-content p-5" id="content">
        ...
        <center>
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                $insertData = "INSERT INTO `empintime` (`empidforattendance`) VALUES ('$EmpID');";
                ...
                if ($result) {
                    ...
                    <strong>Success!</strong> Employee In at <strong>'.date('m/d/Y h:i:s a', time()).'</strong>
            ...
            ?>
                ...
                <form action="attendanceAdmin.php" method="post">
                    ...
                    <div class="buttonsInAttendance ms-9">
                        <button type="submit" class="btn btn-outline-dark mt-3">In Time</button>
                        <a class="btn btn-outline-dark mt-3" href="manuallyInTimeAttendance.php" role="button">Add Manually</a>
                    </div>
                </form>
            </div>
        </center>
