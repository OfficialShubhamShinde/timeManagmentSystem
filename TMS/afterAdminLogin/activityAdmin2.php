    ...
    <div class="page-content p-5" id="content">
        ...
        <div class="container">
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                $insertData1 = "UPDATE activity SET monday = $am1, tuesday = $am2, wednesday = $am3, thursday = $am4, friday= $am5 WHERE emp_id = 123";
                $result1 = mysqli_query($conn, $insertData1);

                $insertData2 = "UPDATE activity SET monday = $am6, tuesday = $am7, wednesday = $am8, thursday = $am9, friday= $am10 WHERE emp_id = 22";
                $result2 = mysqli_query($conn, $insertData2);

                $insertData3 = "UPDATE activity SET monday = $am11, tuesday = $am12, wednesday = $am13, thursday = $am14, friday= $am15 WHERE emp_id = 9530";
