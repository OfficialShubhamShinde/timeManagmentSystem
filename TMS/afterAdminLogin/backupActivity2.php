    ...
    <div class="page-content p-5" id="content">
        ...
        <div class="container">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="d-flex text-black">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="mb-1">Shubham Shinde</h5>
                                                <p class="mb-2 pb-1" style="color: #2b2a2a;">Web Developer</p>
                                                <p class="mb-2 pb-1" style="color: #2b2a2a;">EMP ID: 12345</p>
            ...
            while($row = mysqli_fetch_assoc($tableResult)){
                ...
                echo'
                <form action="activityAdmin2.php" method="post">
                    <tr>
                        <td>
                            <select class="form-select" aria-label="Default select example"  name="activityMonday">
                        ...
                        <td><select class="form-select" aria-label="Default select example" name="">
                        ...
                        <td> <select class="form-select" aria-label="Default select example" name="activityTuesday">
                        ...
                        <td> <select class="form-select" aria-label="Default select example" name="activityWednesday">
                        ...
                        <td> <select class="form-select" aria-label="Default select example" name="activityThursday">
                        ...
                        <td> <select class="form-select" aria-label="Default select example" name="activityFriday">
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                $activityMonday = $_POST['activityMonday'];
                $activityTuesday = $_POST['activityTuesday'];
                $activityWednesday = $_POST['activityWednesday'];
                $activityThursday = $_POST['activityThursday'];
                $activityFriday = $_POST['activityFriday'];

                include '../_dbconnect.php';                

                $insertData = "UPDATE activity SET monday = '$activityMonday', tuesday = '$activityTuesday', wednesday = '$activityWednesday', thursday = '$activityThursday', friday = '$activityFriday'";
            ...
            ?>
                        ...
                        <tr>
                            <td></td>
                            <td><b>Total: <br> 5 hrs</b></td>
                            <td></td>
                            <td><b>Total: <br> 7 hrs</b></td>
                            <td></td>
                            <td><b>Total: <br> 6 hrs</b></td>
                            <td></td>
                            <td><b>Total: <br> 6 hrs</b></td>
                            <td></td>
                            <td><b>Total: <br> 4 hrs</b></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <br>
            <center><button type="button  me-2" class="btn btn-outline-dark mb-3">Save Activity</button></center>
            </form>
            <nav aria-label="...">
