...
<body>
  ...
  <div class="vertical-nav bg-white" id="sidebar">
      ...
      <div class="media d-flex align-items-center">
        ...
        <ul class="nav flex-column bg-white mb-0">
            ...
            <li class="nav-item dropdown">
                <a href="attendanceAdmin.php" class="nav-link text-dark ropdown-toggle"
            ...
            <li class="nav-item">
                <a href="reportsAdmin.php" class="nav-link text-dark bg-light">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <div class="page-content p-5" id="content">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3 mt-4">
                            ...
                            <input type="" class="form-control" id="" placeholder="Enter Your Employee ID">
                        </div>

                        <div>
                            <label for="leavetype" class="form-label">Report By</label>
                            ...
                            <center>
                                <button type="button" class="btn btn-outline-dark" style='margin-right:18px'>Generate
                                    Report</button>
                            </center>
                        </div>
                    </div>
        ...
        <div class="card">
            <div class="card-body">
              <center><h5 class="card-title">Your Report</h5></center>
              <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vitae incidunt voluptates fugiat ratione rerum qui expedita vel optio amet, inventore provident nobis ipsam exercitationem sequi laboriosam consectetur quos eius fugit laborum et possimus maiores reiciendis! Ea explicabo mollitia architecto a iusto maiores, sequi, officiis ut dolore, repellat ipsum magnam repudiandae. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Beatae cupiditate eligendi repellat a voluptatibus enim quo, nobis natus. Placeat est nemo doloribus cupiditate soluta asperiores facere amet debitis quasi exercitationem? Blanditiis, omnis cupiditate? Soluta dolorum quisquam, ducimus mollitia officia ea rem beatae illum temporibus voluptates, quaerat pariatur deleniti facere explicabo!</p>
