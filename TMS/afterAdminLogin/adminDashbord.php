...
<body>
  ...
  <div class="vertical-nav bg-white" id="sidebar">
    ...
    <ul class="nav flex-column bg-white mb-0">
      <li class="nav-item">
        <a href="adminDashbord.php" class="nav-link text-dark bg-light">
  ...
  <div class="page-content p-5" id="content">
    ...
    <div class="container">
      <div class="card mb-3" style="max-width: 540px;">
        <div class="row g-0">
          <div class="col-md-4">
            <img src="../afterAdminLogin/assets/images/unknownUser.jpg" class="img-fluid rounded-start" alt="...">
          </div>
          <div class="col-md-8">

          <?php
          include '../_dbconnect.php';
          $NoOfInterns = "select * from employees where emptype = 'intern'";
          $query1 = mysqli_query($conn, $NoOfInterns);
          $fatchAllIntern = mysqli_num_rows($query1);

          $NoOfEmployees = "select * from employees where emptype = 'employee'";
          $query2 = mysqli_query($conn, $NoOfEmployees);
          $fatchAllEmployees = mysqli_num_rows($query2);
          ?>
              ...
              <table class="table">
                <tbody class="table-group"> 
                  <tr>
                    ...
                    <td><?php echo $fatchAllEmployees ?></td>
                  </tr>
                  <tr>
                    <th scope="row">Intern</th>
                    <td><?php echo $fatchAllIntern ?></td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <div class="row mt-5 justify-content-center">
        <div class="card mb-3 ms-5" style="max-width: 540px;">
          <div class="row g-0">
            <div class="col-md-4">
              <img src="../afterAdminLogin/assets/images/clock.jpg" class="img-fluid rounded-start" alt="...">
      ...
      <div class="row mt-5 justify-content-start">
        <div class="card mb-3 ms-5" style="max-width: 540px;">
          <div class="row g-0">
            ...
            <div class="col-md-8">
              <div class="card-body">
                <h5 class="card-title">Leaves of Absence</h5>
                <hr>
                <table class="table">
                  <tbody class="table-group">
                    <tr>
