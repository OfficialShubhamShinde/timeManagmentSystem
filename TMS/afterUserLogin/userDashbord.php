    ...
    <div class="py-4 px-3 mb-4 bg-light">
      <div class="media d-flex align-items-center">
        ...
        <div class="media-body">
          ...
          <p class="font-weight-normal text-muted mb-0">Welcome <?php echo $_SESSION['loginUsername'] ?></p>
  ...
  <div class="page-content p-5" id="content">
    ...
    <div class="container">
      ...
      <?php
        ...
        $NoOfLeaves = "SELECT * FROM `empintime`";
        $query = mysqli_query($conn, $NoOfLeaves);
        $fatchLeaves = mysqli_num_rows($query);
        ?>
      <script>
        ...
        new Chart(document.getElementById('pie-chart'), {
          type: 'pie',
          data: {
            labels: ["LeaveDays", "WorkingDays", "OnTimeAttendance", "NotTimeAttendance", "AttendingTranningSession"],
            datasets: [{
              backgroundColor: ["#e63946", "#254BDD",
                "#ffbe0b", "#1d3557", "#326998"
              ],
              data: [<?php echo $fatchLeaves ?>, 63, 43, 86, 32]
            }]
          },
          options: {
            title: {
