...
<body>
    ...
    <div class="vertical-nav bg-white" id="sidebar">
        ...
        <ul class="nav flex-column bg-white mb-0">
            ...
            <li class="nav-item">
                <a href="userMyWorkStatus.php" class="nav-link text-dark bg-light">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <div class="page-content p-5" id="content">
        ...
        <div class="container">
           ...
           <div class="d-flex justify-content-center" role="search">
                <button type="button  me-2" class="btn btn-outline-dark mb-3">Save Activity</button>
                <button type="button" class="btn btn-outline-dark mb-3 ms-3">Submit</button>
            </div>
           </center>
            <!-- <div class="btn-group mb-3">
                ...
                <button type="button" class="btn btn-sm btn btn-primary dropdown-toggle dropdown-toggle-split"
